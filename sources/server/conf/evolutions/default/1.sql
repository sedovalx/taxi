...
create table "repair" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"repair_date" TIMESTAMP NOT NULL,"cost" DECIMAL(21,2) NOT NULL,"description" VARCHAR(5000) DEFAULT null,"rent_id" INTEGER NOT NULL,"comment" VARCHAR(5000) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" TIMESTAMP DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" TIMESTAMP DEFAULT null);
