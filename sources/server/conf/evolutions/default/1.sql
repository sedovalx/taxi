...
create table "account" ("id" SERIAL NOT NULL PRIMARY KEY,"login" VARCHAR(254) NOT NULL,"password_hash" VARCHAR(1000) NOT NULL,"last_name" VARCHAR(254) DEFAULT null,"first_name" VARCHAR(254) DEFAULT null,"middle_name" VARCHAR(254) DEFAULT null,"role" VARCHAR(254) NOT NULL,"comment" VARCHAR(1000) DEFAULT null,"creation_date" DATE DEFAULT null,"edit_date" DATE DEFAULT null,"creator_id" INTEGER DEFAULT null,"editor_id" INTEGER DEFAULT null);
create unique index "idx_login_uq" on "account" ("login");
create table "car" ("id" SERIAL NOT NULL PRIMARY KEY,"reg_number" VARCHAR(12) NOT NULL,"make" VARCHAR(255) NOT NULL,"model" VARCHAR(255) NOT NULL,"mileage" DECIMAL(21,2) NOT NULL,"service" DECIMAL(21,2) DEFAULT null,"comment" VARCHAR(1000) DEFAULT null,"creation_date" DATE DEFAULT null,"creator_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"class_id" INTEGER NOT NULL);
create unique index "unique_reg_number" on "car" ("reg_number");
create table "car_class" ("id" SERIAL NOT NULL PRIMARY KEY,"name" VARCHAR(255) NOT NULL,"rate" DECIMAL(21,2) NOT NULL,"creation_date" DATE DEFAULT null,"creator_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"comment" VARCHAR(1000) DEFAULT null);
create unique index "unique_name" on "car_class" ("name");
create table "checkpoint" ("id" SERIAL NOT NULL PRIMARY KEY,"point_date" DATE NOT NULL,"days" INTEGER NOT NULL,"creation_date" DATE DEFAULT null,"creator_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"comment" VARCHAR(1000) DEFAULT null);
create index "point_date_index" on "checkpoint" ("point_date");
create table "driver" ("id" SERIAL NOT NULL PRIMARY KEY,"pass" VARCHAR(254) NOT NULL,"license" VARCHAR(254) NOT NULL,"last_name" VARCHAR(254) DEFAULT null,"first_name" VARCHAR(254) DEFAULT null,"middle_name" VARCHAR(254) DEFAULT null,"phone" VARCHAR(254) NOT NULL,"sec_phone" VARCHAR(254) NOT NULL,"comment" VARCHAR(254) DEFAULT null,"address" VARCHAR(254) NOT NULL,"creation_date" DATE DEFAULT null,"edit_date" DATE DEFAULT null,"creator_id" INTEGER DEFAULT null,"editor_id" INTEGER DEFAULT null);
create unique index "idx_license_uq" on "driver" ("license");
create unique index "idx_pass_uq" on "driver" ("pass");
create table "fine" ("id" SERIAL NOT NULL PRIMARY KEY,"fine_date" DATE NOT NULL,"cost" DECIMAL(21,2) NOT NULL,"description" VARCHAR(1000) DEFAULT null,"rent_id" INTEGER NOT NULL,"comment" VARCHAR(1000) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null);
create table "payment" ("id" SERIAL NOT NULL PRIMARY KEY,"pay_date" DATE NOT NULL,"amount" DECIMAL(21,2) NOT NULL,"target" VARCHAR(255) NOT NULL,"comment" VARCHAR(1000) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null,"rent_id" INTEGER NOT NULL);
create table "rent" ("id" SERIAL NOT NULL PRIMARY KEY,"driver_id" INTEGER NOT NULL,"car_id" INTEGER NOT NULL,"deposit" DECIMAL(21,2) NOT NULL,"comment" VARCHAR(1000) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null);
create table "rent_status" ("id" SERIAL NOT NULL PRIMARY KEY,"change_date" DATE NOT NULL,"status" VARCHAR(255) NOT NULL,"comment" VARCHAR(1000) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null);
create index "change_date_index" on "rent_status" ("change_date");
create index "status_index" on "rent_status" ("status");
create table "repair" ("id" SERIAL NOT NULL PRIMARY KEY,"repair_date" DATE NOT NULL,"cost" DECIMAL(21,2) NOT NULL,"description" VARCHAR(1000) DEFAULT null,"rent_id" INTEGER NOT NULL,"comment" VARCHAR(1000) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null);
...
alter table "car" add constraint "car_class_id_fkey" foreign key("class_id") references "car_class"("id") on update NO ACTION on delete NO ACTION;
...
alter table "car_class" add constraint "car_class_creator_id_fkey" foreign key("creator_id") references "account"("id") on update NO ACTION on delete NO ACTION;
alter table "car_class" add constraint "car_class_editor_id_fkey" foreign key("editor_id") references "account"("id") on update NO ACTION on delete NO ACTION;
...
alter table "car_class" drop constraint "car_class_creator_id_fkey";
alter table "car_class" drop constraint "car_class_editor_id_fkey";
alter table "car" drop constraint "car_class_id_fkey";
