...
create table "fine" ("id" SERIAL NOT NULL PRIMARY KEY,"fine_date" DATE NOT NULL,"cost" DECIMAL(21,2) NOT NULL,"description" VARCHAR(2147483647) DEFAULT null,"rent_id" INTEGER NOT NULL,"comment" VARCHAR(2147483647) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null);
create table "payment" ("id" SERIAL NOT NULL PRIMARY KEY,"pay_date" DATE NOT NULL,"amount" DECIMAL(21,2) NOT NULL,"target" VARCHAR(255) NOT NULL,"comment" VARCHAR(2147483647) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null,"rent_id" INTEGER NOT NULL);
create table "rent" ("id" SERIAL NOT NULL PRIMARY KEY,"driver_id" INTEGER NOT NULL,"car_id" INTEGER NOT NULL,"deposit" DECIMAL(21,2) NOT NULL,"comment" VARCHAR(2147483647) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null);
create table "rent_status" ("id" SERIAL NOT NULL PRIMARY KEY,"change_date" DATE NOT NULL,"status" VARCHAR(255) NOT NULL,"comment" VARCHAR(2147483647) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null);
create index "change_date_index" on "rent_status" ("change_date");
create index "status_index" on "rent_status" ("status");
create table "repair" ("id" SERIAL NOT NULL PRIMARY KEY,"repair_date" DATE NOT NULL,"cost" DECIMAL(21,2) NOT NULL,"description" VARCHAR(2147483647) DEFAULT null,"rent_id" INTEGER NOT NULL,"comment" VARCHAR(2147483647) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null);
