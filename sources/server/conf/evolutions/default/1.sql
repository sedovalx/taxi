...
create table "rent_status" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"change_date" DATE NOT NULL,"status" VARCHAR(255) NOT NULL,"comment" VARCHAR(1000) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null);
create index "change_date_index" on "rent_status" ("change_date");
create index "status_index" on "rent_status" ("status");
create table "repair" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"repair_date" DATE NOT NULL,"cost" DECIMAL(21,2) NOT NULL,"description" VARCHAR(1000) DEFAULT null,"rent_id" INTEGER NOT NULL,"comment" VARCHAR(1000) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" DATE DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" DATE DEFAULT null);
