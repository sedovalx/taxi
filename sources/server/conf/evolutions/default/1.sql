...
create table "checkpoint" ("id" SERIAL NOT NULL PRIMARY KEY,"point_date" TIMESTAMP NOT NULL,"creation_date" TIMESTAMP DEFAULT null,"creator_id" INTEGER DEFAULT null,"edit_date" TIMESTAMP DEFAULT null,"editor_id" INTEGER DEFAULT null,"comment" VARCHAR(2147483647) DEFAULT null);
...
create table "expense" ("id" SERIAL NOT NULL PRIMARY KEY,"timestamp" TIMESTAMP NOT NULL,"amount" DECIMAL(21,2) NOT NULL,"subject" VARCHAR(255) NOT NULL,"description" VARCHAR(1000) DEFAULT null,"comment" VARCHAR(5000) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" TIMESTAMP DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" TIMESTAMP DEFAULT null);
create table "fine" ("id" SERIAL NOT NULL PRIMARY KEY,"fine_date" TIMESTAMP NOT NULL,"cost" DECIMAL(21,2) NOT NULL,"description" VARCHAR(5000) DEFAULT null,"rent_id" INTEGER NOT NULL,"comment" VARCHAR(5000) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" TIMESTAMP DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" TIMESTAMP DEFAULT null);
create table "payment" ("id" SERIAL NOT NULL PRIMARY KEY,"pay_date" TIMESTAMP NOT NULL,"amount" DECIMAL(21,2) NOT NULL,"target" VARCHAR(255) NOT NULL,"comment" VARCHAR(5000) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" TIMESTAMP DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" TIMESTAMP DEFAULT null,"rent_id" INTEGER NOT NULL);
...
create table "rent_status" ("id" SERIAL NOT NULL PRIMARY KEY,"change_date" TIMESTAMP NOT NULL,"status" VARCHAR(255) NOT NULL,"comment" VARCHAR(5000) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" TIMESTAMP DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" TIMESTAMP DEFAULT null,"rent_id" INTEGER NOT NULL);
create index "change_date_index" on "rent_status" ("change_date");
create index "status_index" on "rent_status" ("status");
create table "repair" ("id" SERIAL NOT NULL PRIMARY KEY,"repair_date" TIMESTAMP NOT NULL,"cost" DECIMAL(21,2) NOT NULL,"description" VARCHAR(5000) DEFAULT null,"rent_id" INTEGER NOT NULL,"comment" VARCHAR(5000) DEFAULT null,"creator_id" INTEGER DEFAULT null,"creation_date" TIMESTAMP DEFAULT null,"editor_id" INTEGER DEFAULT null,"edit_date" TIMESTAMP DEFAULT null);
