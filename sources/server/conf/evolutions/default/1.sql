...
create table "driver" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"pass" VARCHAR NOT NULL,"driverCard" VARCHAR NOT NULL,"last_name" VARCHAR,"first_name" VARCHAR,"middle_name" VARCHAR,"phone" BIGINT NOT NULL,"additionalPhone" BIGINT NOT NULL,"comment" VARCHAR NOT NULL,"creation_date" DATE NOT NULL,"edit_date" DATE,"creator_id" BIGINT,"editor_id" BIGINT);
create unique index "idx_license_uq" on "driver" ("driverCard");
create unique index "idx_pass_uq" on "driver" ("pass");
create table "user" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"login" VARCHAR NOT NULL,"password_hash" VARCHAR NOT NULL,"last_name" VARCHAR,"first_name" VARCHAR,"middle_name" VARCHAR,"role" VARCHAR NOT NULL,"creation_date" DATE NOT NULL,"edit_date" DATE,"creator_id" BIGINT,"editor_id" BIGINT);
